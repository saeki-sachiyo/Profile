...
<head>
	...
	<link href="<?php echo get_template_directory_uri(); ?>/house_style.css" rel="stylesheet">
...
<div class="wrap">
	...
	<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
		...
		<div class="container-fluid">
			<a class="navbar-brand" href="#"><img class="icon" src="<?php echo get_template_directory_uri(); ?>/img/logo.png" alt=""></a>
	...
	<div id="home" class="top-img carousel slide" data-ride="carousel">
		...
		<div class="about">
			...
			<div class="p-4">
				...
				<div id="message" class="p-3">
					...
					<p>「子供と一緒に料理がしたい」</p>
					<p>「家族とコミュニケーションを<br class="add_line">たくさん取りたい」</p>
					<p>「服がいっぱいがあるから<br class="add_line">収納スペースはたくさん欲しい」</p>
					<p>「家事がしやすい家がいい」<br class="add_line">「掃除がしやすい家がいい」</p>
					<h5 class="pt-4">Incoronは<br class="add_line">あなたのこだわりが詰まった<br class="add_line">お家を実現します</h5>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="event">
		<div class="Worries mx-md-5">
			...
			<div class="Worries_info">
				<div class="text1 m-0 ">
					<div class="Worries_info1 text-left p-3">
					...
					<h3 class="Worries_info2 mt-3 text-center"><span>Incoron</span>のイベントで<br class="add_line">こんな疑問が解決します</h3>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="comit" class="container-fluid  m-auto">
		...
		<div class="container-fluid padding text-sm-center">
			<div class="row padding m-auto mx-0 my-3 p-0 justify-content-center">
			...
			<div class="row padding mx-0 my-3 p-0 justify-content-center">
				...
				<div id="infolast" class="col-md-6 text-lg-left my-3">
	...
	<section id="access" class="bg-white m-md-5 p-0 text-center claster">
		...
		<div class="row m-3">
			...
			<div class="col-md-6 text-md-left"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3261.4265663082974!2d136.879348215276!3d35.1709193653964!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x888e6049a94311f3!2z5ZCN5Y-k5bGL44Oe44Oq44Kq44OD44OI44Ki44K944K344Ki44Ob44OG44Or!5e0!3m2!1sja!2sjp!4v1588037952651!5m2!1sja!2sjp" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
		</div>
	</section>
