...
<link href="<?php echo get_template_directory_uri(); ?>/style_organic.css"rel="stylesheet">
...
<div class="wrap"> 
  <header id="top-head">
      <div class="inner">
          ...
          <nav id="global-nav">
              <ul>
				  <li><a href="#">Raumとは<span class="sub_title"><br>Brand</span></a></li>
				  <li><a href="#">事業案内<span class="sub_title"><br>Business</span></a></li>
				  <li><a href="#">店舗情報<span class="sub_title"><br>Store</span></a></li>
				  <li><a href="#">求人情報<span class="sub_title"><br>Recruit</span></a></li>
				  <li><a href="#">お知らせ<span class="sub_title"><br>Journal</span></a></li>
              </ul>
          </nav>
      </div>
  </header>
  ...
  <div class="row mx-md-4 mx-2">
    <!--上左側-->
    <div class="content1 col-lg-8" >
      <!--１段目-->
      <div class="movie content px-md-2 px-sm-1 text-center">
        <div id="player"></div>
      </div>
      <!--２段目-->
      <div class="row content px-md-2 px-2">
        <!--２段目左-->
        <div class="col-7 px-md-3 px-1 m-auto content">
          <a href="#">
        ...
        <!--２段目右-->
        <div class="between col-5 p-md-3 p-2 row content m-auto p">
    ...
    <div class="row content2 between col-lg-4 px-2 text-center">
      ...
      <div class="content2-2 col-sm-6 col-lg-12 px-0 mx-2">
		  <div class="about p-2">
		  ...
		  <!--３段目-->
		  <div class="reserve content pb-3 px-2 m-auto">
			  <a href="#">
